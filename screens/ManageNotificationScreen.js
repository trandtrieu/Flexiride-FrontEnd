    ...
    const fetchNotifications = async () => {
        try {
            ...
            if (response.data && Array.isArray(response.data.notifications)) {
                ...
                const unreadNotifications = sortedNotifications.filter(notification =>
    ...
    return (
        <View style={styles.container}>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <TouchableOpacity
                        style={[styles.notificationCard, !item.readBy.length && styles.unreadNotification]} // Thêm class cho thông báo chưa đọc
